...
// Leaflet's own size/tile chatter, leaving the view offset from
// the requested centre. setView lands the view in one frame so
// nothing can race with it. Confirmed on real-device testing
// 2026-06-09.
